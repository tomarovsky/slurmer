...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T104.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T104.mmar.err
...
fastq1="T104.subsampling_220kk_1.fastq.gz"
fastq2="T104.subsampling_220kk_2.fastq.gz"
