...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/S46.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/S46.mmar.err
...
fastq1="S46.subsampling_220kk_1.fastq.gz"
fastq2="S46.subsampling_220kk_2.fastq.gz"
