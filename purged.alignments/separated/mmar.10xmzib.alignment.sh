...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/10xmzib.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/10xmzib.mmar.err
...
sample="10xmzib"
samplepath="/mnt/tank/scratch/skliver/common/mustelidae/martes_zibellina/genome/reads/filtered/10x/"
fastq1="10xmzib.ema.subsampling_220kk_1.fastq.gz"
fastq2="10xmzib.ema.subsampling_220kk_2.fastq.gz"
