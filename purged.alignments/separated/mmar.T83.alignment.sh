...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T83.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T83.mmar.err
...
fastq1="T83.22x_1.fastq.gz"
fastq2="T83.22x_2.fastq.gz"
