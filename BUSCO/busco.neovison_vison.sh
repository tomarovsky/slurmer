#!/bin/bash -l
#SBATCH --job-name=neovison_vison
#SBATCH --mail-type=END
#SBATCH --mail-user=andrey.tomarovsky@gmail.com
#SBATCH --cpus-per-task=16
#SBATCH --mem=128gb
#SBATCH --time=150:00:00
#SBATCH --output=/mnt/tank/scratch/atomarovsky/logs/busco.neovison_vison.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/logs/busco.neovison_vison.err
