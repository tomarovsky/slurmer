...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T50.mzib.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T50.mzib.err
...
fastq1="T50.subsampling_220kk_1.fastq.gz"
fastq2="T50.subsampling_220kk_2.fastq.gz"
