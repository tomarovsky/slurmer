...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/S44.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/S44.mmar.err
...
fastq1="S44.subsampling_220kk_1.fastq.gz"
fastq2="S44.subsampling_220kk_2.fastq.gz"
