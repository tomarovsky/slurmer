...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T86.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T86.mmar.err
...
fastq1="T86.22x_1.fastq.gz"
fastq2="T86.22x_2.fastq.gz"
