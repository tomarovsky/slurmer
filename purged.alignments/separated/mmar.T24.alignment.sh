...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T24.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T24.mmar.err
...
fastq1="T24.22x_1.fastq.gz"
fastq2="T24.22x_2.fastq.gz"
