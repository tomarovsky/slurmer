...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T18.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T18.mmar.err
...
fastq1="T18.subsampling_220kk_1.fastq.gz"
fastq2="T18.subsampling_220kk_2.fastq.gz"
