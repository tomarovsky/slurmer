...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T77.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T77.mmar.err
...
fastq1="T77.22x_1.fastq.gz"
fastq2="T77.22x_2.fastq.gz"
