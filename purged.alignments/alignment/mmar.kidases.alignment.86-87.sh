...
#SBATCH --array=86,87
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/mmar_T%a.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/mmar_T%a.err
...
bwa mem -t 8 ${assembly} ${samplepath}/${sample}/${fastq1} ${samplepath}/${sample}/${fastq2} -R "@RG\tID:${sample}\tPU:x\tSM:${sample}\tPL:Illumina\tLB:x" | samtools fixmate -@ 2 -m - - | samtools sort -@ 4 -m 12G | samtools markdup -@ 2 - ${sample}.mmar.hic.purged.mkdup.bam;
