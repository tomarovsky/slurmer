...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T72.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T72.mmar.err
...
fastq1="T72.subsampling_220kk_1.fastq.gz"
fastq2="T72.subsampling_220kk_2.fastq.gz"
