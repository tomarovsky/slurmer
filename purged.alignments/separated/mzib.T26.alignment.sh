...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T26.mzib.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T26.mzib.err
...
fastq1="T26.subsampling_220kk_1.fastq.gz"
fastq2="T26.subsampling_220kk_2.fastq.gz"
