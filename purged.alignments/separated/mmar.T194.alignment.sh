...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T194.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T194.mmar.err
...
fastq1="T194.final_1.fastq.gz"
fastq2="T194.final_2.fastq.gz"
