...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/S26.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/S26.mmar.err
...
fastq1="S26.final_1.fastq.gz"
fastq2="S26.final_2.fastq.gz"
