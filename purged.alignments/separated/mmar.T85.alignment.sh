...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T85.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T85.mmar.err
...
fastq1="T85.22x_1.fastq.gz"
fastq2="T85.22x_2.fastq.gz"
