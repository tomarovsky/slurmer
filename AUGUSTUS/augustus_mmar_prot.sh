...
#SBATCH --output=/nfs/home/atomarovsky/augummp.log
#SBATCH --error=/nfs/home/atomarovsky/augummp.err       
...
hints_gff="/mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/all_hints/protein_hints.gff"
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/augustus_only_protein_output/; pwd;
