...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T8.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T8.mmar.err
...
fastq1="T8.subsampling_220kk_1.fastq.gz"
fastq2="T8.subsampling_220kk_2.fastq.gz"
