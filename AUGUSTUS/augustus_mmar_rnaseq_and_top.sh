#!/bin/bash -l
#SBATCH --job-name=augumm
#SBATCH --mail-type=END
#SBATCH --mail-user=andrey.tomarovsky@gmail.com
#SBATCH --cpus-per-task=32
#SBATCH --mem=256gb
#SBATCH --time=150:00:00
#SBATCH --output=/nfs/home/atomarovsky/augummrt.log
#SBATCH --error=/nfs/home/atomarovsky/augummrt.err       
...
hints_gff="/mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/all_hints/rnaseq_and_top_hints.gff"
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/augustus_rnaseq_and_top_output/; pwd;
