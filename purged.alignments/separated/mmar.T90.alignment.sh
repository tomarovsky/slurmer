...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T90.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T90.mmar.err
...
fastq1="T90.final_1.fastq.gz"
fastq2="T90.final_2.fastq.gz"
