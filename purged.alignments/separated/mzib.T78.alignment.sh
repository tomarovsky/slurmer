...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T78.mzib.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T78.mzib.err
...
fastq1="T78.22x_1.fastq.gz"
fastq2="T78.22x_2.fastq.gz"
