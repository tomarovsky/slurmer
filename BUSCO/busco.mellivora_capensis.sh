...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/logs/busco.mellivora_capensis.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/logs/busco.mellivora_capensis.err
