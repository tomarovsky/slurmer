...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/S49.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/S49.mmar.err
...
fastq1="S49.subsampling_220kk_1.fastq.gz"
fastq2="S49.subsampling_220kk_2.fastq.gz"
