#!/bin/bash
#SBATCH --job-name=mmdepstat11
#SBATCH --mail-type=END
#SBATCH --mail-user=andrey.tomarovsky@gmail.com
#SBATCH --cpus-per-task=5
#SBATCH --mem=20gb
#SBATCH --time=150:00:00
#SBATCH --output=/mnt/tank/scratch/atomarovsky/mmdepstat11.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/mmdepstat11.err 
squeue; hostname; date;
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/aligment/hic/bwa_aligment/; pwd;
for i in SRR13213811; do
	cd $i;
