...
#SBATCH --output=/nfs/home/atomarovsky/augumz.log
#SBATCH --error=/nfs/home/atomarovsky/augumz.err       
...
hints_gff="/mnt/tank/scratch/skliver/common/mustelidae/martes_zibellina/genome/annotation/hic1/gene_annotation/all_hints/all_hints.gff"
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_zibellina/genome/annotation/hic1/gene_annotation/augustus_output/; pwd;
