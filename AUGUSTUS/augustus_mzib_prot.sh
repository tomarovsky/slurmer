...
#SBATCH --output=/nfs/home/atomarovsky/augumzp.log
#SBATCH --error=/nfs/home/atomarovsky/augumzp.err       
...
hints_gff="/mnt/tank/scratch/skliver/common/mustelidae/martes_zibellina/genome/annotation/hic1/gene_annotation/all_hints/protein_hints.gff"
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_zibellina/genome/annotation/hic1/gene_annotation/augustus_only_protein_output/; pwd;
