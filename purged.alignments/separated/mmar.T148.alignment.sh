...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T148.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T148.mmar.err
...
fastq1="T148.subsampling_220kk_1.fastq.gz"
fastq2="T148.subsampling_220kk_2.fastq.gz"
