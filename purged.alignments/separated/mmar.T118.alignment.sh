...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T118.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T118.mmar.err
...
fastq1="T118.subsampling_220kk_1.fastq.gz"
fastq2="T118.subsampling_220kk_2.fastq.gz"
