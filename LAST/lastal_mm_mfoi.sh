...
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_foina/genome/aligment/lastal/; pwd;

$TOOLS/last-1179/bin/lastal -P 15 -R11 -f MAF -i 4G /mnt/tank/scratch/skliver/common/mustelidae/martes_foina/genome/index/lastal/martes_foina.YASS.R11.soft /mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/repeats/mmar.min_150.pseudohap2.1_HiC.repeatmasker.trf.windowmasker.fasta.gz | tee martes_martes.to.martes_foina.R11.maf | maf-convert tab > martes_martes.to.martes_foina.R11.tab ;
