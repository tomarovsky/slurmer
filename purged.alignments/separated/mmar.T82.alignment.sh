...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T82.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T82.mmar.err
...
fastq1="T82.22x_1.fastq.gz"
fastq2="T82.22x_2.fastq.gz"
