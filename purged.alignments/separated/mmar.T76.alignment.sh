...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T76.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T76.mmar.err
...
fastq1="T76.22x_1.fastq.gz"
fastq2="T76.22x_2.fastq.gz"
