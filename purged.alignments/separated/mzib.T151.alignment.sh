...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T151.mzib.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T151.mzib.err
...
fastq1="T151.subsampling_220kk_1.fastq.gz"
fastq2="T151.subsampling_220kk_2.fastq.gz"
