...
#SBATCH --output=/nfs/home/atomarovsky/augumm.log
#SBATCH --error=/nfs/home/atomarovsky/augumm.err       
...
hints_gff="/mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/all_hints/all_hints.gff"
cd /mnt/tank/scratch/skliver/common/mustelidae/martes_martes/genome/annotation/gene_annotation/augustus_output/; pwd;
