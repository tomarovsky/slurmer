...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/T84.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/T84.mmar.err
...
fastq1="T84.22x_1.fastq.gz"
fastq2="T84.22x_2.fastq.gz"
