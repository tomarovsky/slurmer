...
#SBATCH --output=/mnt/tank/scratch/atomarovsky/purged.alignments/S50.mmar.log
#SBATCH --error=/mnt/tank/scratch/atomarovsky/purged.alignments/S50.mmar.err
...
fastq1="S50.final_1.fastq.gz"
fastq2="S50.final_2.fastq.gz"
